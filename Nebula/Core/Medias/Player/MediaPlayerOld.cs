...
{
    public class MediaPlayerOld : Component
    {
        ...
        public bool IsMuted
        {
            ...
            set
            {
                ...
                _muted = value;
                PlaybackMuteChanged?.Invoke(this, new MuteChangedEventArgs(value));
            }
        }
        ...
        public int Volume
        {
            ...
            set
            {
                ...
                PlaybackVolumeChanged?.Invoke(this, new VolumeChangedEventArgs(oldVolume, Volume));
            }
        }

        public event EventHandler<VolumeChangedEventArgs>   PlaybackVolumeChanged;
        public event EventHandler<MuteChangedEventArgs>     PlaybackMuteChanged;
        ...
        public async Task OpenMedia(IMediaInfo mediaInfo, bool manualStop = false, bool play = true, bool fromServer = false)
        {
            ...
            {
                NebulaClient.Network.SendPacket(new SharedSessionPlayMediaPacket {MediaInfo = mediaInfo.AsMediaInfo()});
                _manualStop = false;
                return;
            }
